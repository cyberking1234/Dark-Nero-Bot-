...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/8d9b28ad270713cb8d954.jpg'
module.exports = {
  ...
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? '🔥 HELLO IM ALIVE 🔥' : process.env.ALIVE_MESSAGE,
